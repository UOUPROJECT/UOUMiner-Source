...
uouminer 1.0                     "phi2 and cryptonight variants"
---------------------------------------------------------------
...
Example for uoucoin Mining on uoupool.pw with a single gpu in your system
    uouminer -t 1 -a pipe -o stratum+tcp://uoupool.pw:9393 -u <<username.worker>> -p <<workerpassword>> -v 8
